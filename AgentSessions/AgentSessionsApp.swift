...
extension AgentSessionsApp {
    ...
    private func presentAnalyticsOnDemandNoticeIfNeeded() {
        ...
        alert.messageText = String(localized: "Analytics Is Now On Demand")
    ...
    private func presentCrashRecoveryPrompt(newCrashCount: Int) async {
        ...
        alert.messageText = String(localized: "Crash report detected")
        alert.informativeText = """
        ...
        """
        alert.addButton(withTitle: String(localized: "Email Crash Report"))
        alert.addButton(withTitle: String(localized: "Export + Open GitHub Issue"))
