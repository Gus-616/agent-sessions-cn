...
final class StatusItemController: NSObject {
    ...
    private func buildMenu() -> NSMenu {
        ...
        if liveSessionsEnabled {
            ...
            menu.addItem(makeTitleItem(String(format: String(localized: "%lld active • %lld waiting"), summary.activeCount, summary.waitingCount)))
    ...
    private func makeTitleItem(_ title: String) -> NSMenuItem {
        let it = NSMenuItem(title: NSLocalizedString(title, comment: ""), action: nil, keyEquivalent: "")
        it.isEnabled = false
        return it
    }
    private func makeActionItem(title: String, action: Selector) -> NSMenuItem {
        let it = NSMenuItem(title: NSLocalizedString(title, comment: ""), action: action, keyEquivalent: "")
        it.target = self
        return it
    }
