...
enum AnalyticsAgentFilter: String, CaseIterable, Identifiable {
    ...
    var title: String {
        switch self {
        case .all: return String(localized: "All Agents")
        case .codexOnly: return String(localized: "Codex Only")
        case .claudeOnly: return String(localized: "Claude Only")
        case .geminiOnly: return String(localized: "Gemini Only")
        case .opencodeOnly: return String(localized: "OpenCode Only")
        case .copilotOnly: return String(localized: "Copilot Only")
        case .droidOnly: return String(localized: "Droid Only")
        case .openclawOnly: return String(localized: "OpenClaw Only")
        }
    }
