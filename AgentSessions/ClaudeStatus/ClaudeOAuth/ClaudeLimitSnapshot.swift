...
enum ClaudeUsageMode: String, CaseIterable {
    ...
    var displayName: String {
        switch self {
        case .auto: return String(localized: "Auto (OAuth + tmux)")
        case .oauthOnly: return String(localized: "OAuth only")
        case .tmuxOnly: return String(localized: "tmux only")
        case .webOnly: return String(localized: "Web API only")
        }
    }
}
