...
struct PreferencesView: View {
    ...
    func agentUpdateButtonTitle(for source: SessionSource) -> String {
        if agentUpdatingSources.contains(source) { return String(localized: "Updating...") }
        if agentUpdateCheckingSources.contains(source) { return String(localized: "Checking...") }
...
enum PreferencesTab: String, CaseIterable, Identifiable {
    ...
    var title: String {
        ...
        case .usageTracking: return String(localized: "Usage Tracking")
        case .usageProbes: return String(localized: "Usage Probes")
        case .menuBar: return String(localized: "Menu Bar")
        case .unified: return String(localized: "Unified Window")
        case .advanced: return String(localized: "Advanced")
        case .agentCockpit: return String(localized: "Agent Cockpit")
        case .codexCLI: return String(localized: "Codex CLI")
        case .claudeResume: return String(localized: "Claude Code")
        case .opencode: return String(localized: "OpenCode")
        case .geminiCLI: return String(localized: "Gemini CLI")
        case .copilotCLI: return String(localized: "GitHub Copilot CLI")
        case .droidCLI: return String(localized: "Droid")
        case .openClawCLI: return String(localized: "OpenClaw")
