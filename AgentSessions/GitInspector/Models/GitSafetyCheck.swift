...
public struct GitSafetyCheck: Equatable {
    ...
    public enum SafetyStatus: String, Equatable {
        ...
        public var badgeText: String {
            switch self {
            case .safe: return String(localized: "All Clear")
            case .caution: return String(localized: "Changes Detected")
            case .warning: return String(localized: "Conflict Risk")
        ...
        public var displayTitle: String {
            ...
            case .caution: return String(localized: "Session Has Evolved")
            case .warning: return String(localized: "Major Changes Detected")
            case .unknown: return String(localized: "Unable to Verify")
            }
        }
